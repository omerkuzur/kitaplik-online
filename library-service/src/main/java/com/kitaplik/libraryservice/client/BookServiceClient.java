...
public interface BookServiceClient {
    ...
    default ResponseEntity<BookIdDto> getBookFallback(String isbn, Exception excepiton){
    ...
    default ResponseEntity<BookDto> getBookByIdFallback(String bookId, Exception excepiton) {
